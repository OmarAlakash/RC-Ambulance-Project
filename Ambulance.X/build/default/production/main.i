...
void Set_PWM_Duty(unsigned int duty_us) {
    unsigned int duty = (duty_us * (4000000 / 4)) / (16 * (PR2 + 1) * 1000);
    CCPR1L = duty >> 2;
    CCP1CONbits.CCP1X = (duty & 0x02) >> 1;
